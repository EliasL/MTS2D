...
//   double x78 = x24 * x77;
//   double x79 =
//       -2.333333333333333 * x6 + 2.333333333333333 * x7 + 2.333333333333333 *
//       x8;
...
//                        2 * x181 - 0.22222222222222221 * x182 + 4 * x38 *
//                        x57);
//   double x185 = 4 * x51;
...
//                        2 * x229 - 0.22222222222222221 * x230 + 4 * x89 *
//                        x99);
//   double x233 = 4 * x112;
...
//                        0.22222222222222221 * x273 - 0.22222222222222221 *
//                        x274);
//   double x277 = 12 * x244;
...
//   double dPhi_dC11 =
//       beta * (-0.0064709595959595969 * x45 + x46 * x73 + x47 * x80 + x62 *
//       x81 +
//               0.000946969696969697 * x67 + x71 * x72 + x74 * x78) -
//       c22 * x4 * (x3 - 1) + x20 * x25 - x28 * x32 + 0.005681818181818182 *
//       x45 - x47 * x49 + x62 * x64 - x62 * x65 + 0.032196969696969696 * x67;
//   double dPhi_dC22 = beta * (x104 * x81 + 0.000946969696969697 * x106 +
//                              x107 * x108 + x109 * x110 + x73 * x95 + x80 *
//                              x96 - 0.0064709595959595969 * x94) -
...
//            x126 * x73 + x127 * x80 + x134 * x81 + 0.000946969696969697 *
//            x136) +
...
//            x110 *
//                (-1.7499999999999998 * x193 + 1.7499999999999998 * x194 +
//                x238) -
//            x190 * x206 + x207 * x240 - 0.0064709595959595969 * x218 +
//            x219 * x241 + x220 * x73 + x221 * x80 + 0.000946969696969697 *
//            x222 + x231 * x81 + 0.000946969696969697 * x232 + x236 * x85 +
//            x240 * x96) +
...
//            x116 * x137 * x235 + x126 * x137 * x239 + x127 * x281 - x190 *
//            x252 + x241 * x264 + x253 * x281 - 0.0064709595959595969 * x263 +
...
//       + 2 * x4 * (2 * x1 * x139 + x3 - 1) - x86 * (9 * x242 + 9 * x243 -
//       x246);
...
//            + x306 * x81 + 0.000946969696969697 * x307 + x308 * x85 + x309 *
//            x95 + x312 * x95) +
...
//            x138 * x315 - x190 * x251 * x44 + 0.000946969696969697 * x24 *
//            x337 - 0.0064709595959595969 * x325 * x34 + x326 * x80 + x327 *
//            x80 + x328 * x73 + x329 * x80 + x336 * x81) -
...
//       0.005681818181818182 * x325 * x34 - x326 * x49 - x327 * x49 - x329 *
//       x49 + 0.037037037037037028 * x336 * x63 - x336 * x65;
...
//            x116 * x236 + x137 * x310 * x95 + 0.015151515151515152 * x138 *
//            x96 - x190 * x251 * x93 + 0.000946969696969697 * x24 * x356 -
...
//       0.005681818181818182 * x34 * x345 - x346 * x49 - x347 * x49 - x349 *
//       x49 + 0.037037037037037028 * x355 * x63 - x355 * x65;
